...
export default function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative w-12 h-6 rounded-full bg-yametee-lightGray dark:bg-yametee-gray transition-colors duration-300 focus:outline-none focus:ring-2 focus:ring-yametee-red focus:ring-offset-2 focus:ring-offset-white dark:focus:ring-offset-yametee-bg"
